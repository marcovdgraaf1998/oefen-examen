<?php
    ...
    if (is_numeric($id)) {
        $resultEdit = mysqli_query($mysqli, "SELECT * FROM oefenexamen_enquetes WHERE id = $id");
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM oefenexamen_users ORDER BY last_name");
...
<body>
    <?php if($user_level == 1 && $filled_in == 0) : ?>
        <div class="container">
        <div class="student">
            <div class="text-center mt-4">
                <a class="text-center btn btn-danger" href="includes/logout.php">Uitloggen</a>
            </div>
            <h3 class="text-center mt-4">Hallo, <?= $_SESSION['first_name'] ?></h3>
            ...
            <form action="process/form.php" method="post">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="travel-time" name="travel-time">
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col">
                        <label for="transport">Welke voermiddel(en) gebruik je om naar het GLR te reizen?</label>
    ...
    <?php elseif ($user_level == 1 && $filled_in == 1) :  ?>
